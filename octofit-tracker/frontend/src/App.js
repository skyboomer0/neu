      ...
      <div className="container py-4">
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav ms-auto">
                <li className="nav-item">
                  <Link className="nav-link" to="/activities">Aktivitäten</Link>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="/users">Benutzer</Link>
                </li>
                <li className="nav-item">
        ...
        <div className="card shadow-sm p-4">
          <Routes>
            ...
            <Route path="/" element={<h1 className="display-4 text-primary">Willkommen bei OctoFit Tracker</h1>} />
          </Routes>
        </div>
      </div>
    </Router>
